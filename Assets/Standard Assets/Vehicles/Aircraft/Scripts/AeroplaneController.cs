...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] public float m_PitchEffect = 1f;            // The strength of effect for pitch input.
        ...
        public Text m_throttleText;

        public Transform m_propeller;

        public GameObject m_propellerBlur1;
        public GameObject m_propellerBlur2;
        public GameObject m_propellerPropeller;
        ...
        public void Update()
        {
            ...
            {
                //Display throttle
                m_throttleText.text = "Throttle: " + (Throttle * 100).ToString("0") + "%";
                ...
                {
                    ShowPropeller();
                    m_propeller.Rotate(0, 0, ((Throttle * 300.0f) + 1) * -1);
                }
                else
                {
                    m_propellerBlur1.SetActive(true);
                    m_propellerBlur1.SetActive(true);
                    m_propellerPropeller.SetActive(false);
                    m_propeller.Rotate(0, 0, (Throttle * 100.0f) + 0);
